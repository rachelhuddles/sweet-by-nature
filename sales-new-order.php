...
<!--
	...
	sales-new-order.php
	For placing new customer orders
-->
<html lang="en">
<head>
	<title>New Order | Sweet by Nature, Inc.</title> 
	<meta charset="utf-8">
...
<nav class="navbar navbar-expand-lg navbar-dark">
	...
	<div class="main-links border-top border-light">
		<h1 class="text-center">Place a New Order</h1>
		
		
		
			<form action="sales-new-orderphp.php" method="post">
			Company ID: <br><input type="textarea" name="companyID" size="50" ><br><br>
			<input type="radio" name="product" value="seedling"> Seedling 
			<input type="radio" name="product" value="extract"> Extract <br><br>
			Order Amount: <br><input type="textarea" name="quantity" size="50"><br><br>
			Order Date (YYYY/MM/DD): <br><input type="textarea" name="orderDate" size="50" ><br><br>
