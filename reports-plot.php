<?PHP if (!session_id()) session_start(); if (!$_SESSION[ 'logon']){ header( "Location:index.html"); die(); } require_once( 'database.php'); $queryPlots='Select PlotID, PlantDate, AmountPlanted 
    From seedlingPlots 
    Order By PlotID' ; $statement=$ db -> prepare($queryPlots); $statement -> execute(); $plots = $statement -> fetchAll(); $statement -> closeCursor(); ?>
...
<body>
    ...
    <div class="main-links border-top border-light">
        <h1 class="text-center">Honeybush Plot Reports</h1>
        ...
        <table cellpadding="0" cellspacing="0" style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    <?php echo $p[ 'PlantDate']; ?>
                </td>
                <td>
                    <?php echo $p[ 'AmountPlanted']; ?>
                </td>
            </tr>
            <?php } ?>
    </div>
