...
$CusFirstName = $_POST['cFName']; 
$CusLastName = $_POST['cLName'];
$ShippingAddress = $_POST['shipping'];
$CusCity = $_POST['city']; 
$CusState = $_POST['state']; 
$CusZip = $_POST['zip']; 
$CusPhoneNumber = $_POST['phoneNum']; 
...
$sql = "INSERT INTO `Customer` (CompanyID, CompanyName, CustomerFirstName,
CustomerLastName, CustomerShippingAddress, CustomerCity, CustomerState,
CustomerZip, CustomerPhoneNumber, CustomerEmail)
VALUES ('$CompanyID', '$CompanyName', '$CusFirstName', '$CusLastName', '$ShippingAddress',
'$CusCity', '$CusState', '$CusZip', '$CusPhoneNumber', '$CusEmail')";
