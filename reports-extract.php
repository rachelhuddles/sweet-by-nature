<?PHP if (!session_id()) session_start(); if (!$_SESSION[ 'logon']){ header( "Location:index.html"); die(); } require_once( 'database.php'); $queryExtract='select c.CompanyID, c.CompanyName, o.OrderID, o.Product, o.OrderAmount, o.OrderDate
    from Customer as c, Orders as o
    where c.CompanyID = o.CompanyID
    and o.Product = "Extract"
    group by o.OrderID' ; $statement=$ db -> prepare($queryExtract); $statement -> execute(); $extract = $statement -> fetchAll(); $statement -> closeCursor(); ?>
...
<!--
	...
	reports-extract.html
	Honeybush Extract Reports
-->
<html lang="en">

<head>
    <title>Honeybush Extract Reports | Sweet by Nature, Inc.</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="main-links border-top border-light">
        <h1 class="text-center">Honeybush Extract Reports</h1>

        <!-- 
			
			PHP TABLE FOR ACCESSING HONEYBUSH EXTRACT REPORTS WILL GO HERE
        ...
        <table cellpadding="0" cellspacing="0" style="width: 100%">
            ...
            <?php foreach ($extract as $e) { ?>
            <tr>
                <td>
                    <?php echo $e[ 'CompanyID']; ?>
                </td>
                <td>
