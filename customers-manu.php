...
<!--
	...
	customers-manu.html
	Beverage Manufacturer Customers
-->
<html lang="en">
<head>
	<title>Existing Beverage Manufacturer Customers | Sweet by Nature, Inc.</title> 
	<meta charset="utf-8">
...
<div class="main-links border-top border-light">
		<h1 class="text-center">Beverage Manufacturer Customers</h1>		
		<div class="pl-4">
			...
			Customer.CompanyID=Orders.CompanyID WHERE Orders.Product='Extract'";
