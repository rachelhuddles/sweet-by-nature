...
<html lang="en">
<head>
	<title>Add a New Customer | Sweet by Nature, Inc.</title> 
	<meta charset="utf-8">
...
<nav class="navbar navbar-expand-lg navbar-dark">
	...
	<div class="main-links border-top border-light">
		<h1 class="text-center">Add a New Customer</h1>
			...
			<form action="customers-newphp.php" method="post">
			Company ID: <br><input type="textarea" name="comID" size="50" ><br><br>
			Company Name: <br><input type="textarea" name="comName" size="50"><br><br>
			Customer First Name: <br><input type="textarea" name="cFName" size="50" ><br><br>
			Customer Last Name: <br><input type="textarea" name="cLName" size="50" ><br><br>
			Customer Shipping Address: <br><input type="textarea" name="shipping" size="50" ><br><br>
			Customer City: <br><input type="textarea" name="city" size="50" ><br><br>
			Customer State: <br><input type="textarea" name="state" size="50" ><br><br>
			Customer Zip: <br><input type="textarea" name="zip" size="50" ><br><br>
			Customer Phone Number: <br><input type="textarea" name="phoneNum" size="50" ><br><br>
			Customer Email: <br><input type="textarea" name="email" size="50" ><br><br>
